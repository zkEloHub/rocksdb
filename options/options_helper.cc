    ...
    OptionsHelper::cf_options_type_info = {
        ...
        {"compaction_measure_io_stats",
         {0, OptionType::kBoolean, OptionVerificationType::kDeprecated, false,
          0}},
        {"with_nvm",
         {offset_of(&ColumnFamilyOptions::with_nvm),
          OptionType::kBoolean, OptionVerificationType::kNormal, true, 0}},
        {"with_num_trigger",
         {offset_of(&ColumnFamilyOptions::with_num_trigger),
          OptionType::kBoolean, OptionVerificationType::kNormal, true, 0}},
        {"Level0_column_compaction_trigger_size",
         {offset_of(&ColumnFamilyOptions::Level0_column_compaction_trigger_size),
          OptionType::kUInt64T, OptionVerificationType::kNormal, true, 0}},
        {"Level0_column_compaction_slowdown_size",
         {offset_of(&ColumnFamilyOptions::Level0_column_compaction_slowdown_size),
          OptionType::kUInt64T, OptionVerificationType::kNormal, true, 0}},
        {"Level0_column_compaction_stop_size",
         {offset_of(&ColumnFamilyOptions::Level0_column_compaction_stop_size),
          OptionType::kUInt64T, OptionVerificationType::kNormal, true, 0}},
        ...
        {"meta_buffer_size",
         {offset_of(&ColumnFamilyOptions::meta_buffer_size),
          OptionType::kSizeT, OptionVerificationType::kNormal, true, 0}},
        {"bloom_locality",
